...
SVC_NAME="actions.runner.lijded-devsecops.compute-vm-4-8-20-ssd-1774821415189.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (lijded-devsecops.compute-vm-4-8-20-ssd-1774821415189)"
